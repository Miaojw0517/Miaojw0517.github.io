...
const commentBarrageConfig = {
      ...
      twikooUrl: "https://knight-twikoo.cn/",
      //token获取见前文
      accessToken: "8aa24539bf324829b0d843ae646b386e",
  ...
  function isInViewPortOfOne (el) {
      if (!el) return
    //   console.log('isInViewPortOfOne el', el)
  ...
  document.onscroll = function() {
      if(commentBarrageConfig.displayBarrage && document.getElementById("post-comment")){
  ...
  function initCommentBarrage(){
          ...
          xhr.addEventListener("readystatechange", function() {
            ...
            //   console.log('this.responseText', this.responseText)
              ...
              commentBarrageConfig.dom ? commentBarrageConfig.dom.innerHTML = '' : '';
            }
          });
          ...
          setInterval(()=>{
              if(commentBarrageConfig.barrageList.length){
                //   console.log('commentBarrageConfig.barrageList', commentBarrageConfig.barrageList)
